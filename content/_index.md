...
[extra]
authors = [
    {name = "Duc Thanh Tran", url = "https://ducthanhtran.github.io/"},
]
venue = {name = "GitHub", url = "https://github.com/ducthanhtran"}
buttons = [
...
$$
```
This theme also supports footnotes, and will style the heading that immediately precedes them
